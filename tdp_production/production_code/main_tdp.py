...
if __name__ in "__main__":
    csv_path = r"C:\Users\1000303969\OneDrive - Western Digital\work\tdp classification\VL_TDP\6FPW\3ZH5X4UZ.csv"
    ...
    tdp_profile = TDP_Profile(csv_path, model_config, prediction_mode="condition")
